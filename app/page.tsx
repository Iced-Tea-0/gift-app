    ...
    <main className="min-h-screen overflow-hidden relative">
      ...
      <section className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-100px)] px-6 text-center">
        ...
        <div className="mt-12 flex gap-4 justify-center flex-wrap">
          <Link href="/auth" className="btn-gradient text-white px-8 py-3 rounded-full font-bold hover:shadow-xl transition inline-block">
            Start Planning
          </Link>
          <button className="border-2 border-pink-600 text-pink-600 px-8 py-3 rounded-full font-bold hover:bg-pink-50 transition">
            Learn More
          </button>
        </div>
      ...
      <footer className="relative z-10 border-t border-pink-200 bg-white/40 backdrop-blur-sm px-8 py-12 mt-20">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-8">
            ...
            <a href="#" className="text-gray-600 hover:text-pink-600 transition">Contact</a>
          </div>
        </div>
      </footer>
